...
import { fetchUpcomingMovies, image185, fallbackMoviePoster } from '../api/moviedb'; // Import API functions and image URLs
...
export default function UpcomingMoviesScreen() {
  ...
  useEffect(() => {
    const getUpcomingMovies = async () => {
      const upcomingMovies = await fetchUpcomingMovies(); // Fetch movies from API
      setMovies(upcomingMovies.results); // Update movies state
